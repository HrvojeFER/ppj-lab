...
class ConstantResolver:
    ...
    def resolve(member):
        ...
        return [ConstantResolver.resolve_assign(member.get_content()[0])]
...
class FRISC:
    ...
    def generate_mul():
        ...
        FRISC.program.append(Command.build_jp_with_condition("C", "FIRST_NEG"))

        FRISC.program.append(Command.build_rotl("R1", 1, "R1"))
        FRISC.program.append(Command.build_jp_with_condition("C", "SECOND_NEG"))
...
class PostfiksIzraz:
    ...
    def generate(self):
        ...
        if content_type is OtherType.POSTFIKS_PUNE_ZAGRADE:
            var_num = 1
            arg_list = copy.deepcopy(self.get_content()[2])

            while arg_list.get_content_type() == OtherType.LISTA_ARGUMENATA_UZ_IZRAZ:
                arg_list = arg_list.get_content()[0]
                var_num = var_num + 1
